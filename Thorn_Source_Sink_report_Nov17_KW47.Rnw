...
#n.steps<-360*10
n.steps<-360*10 # number of time steps to run model for
...
#########################################################################################
# Here I am assuming that a leaf of mass less than 0.1 grammes cannot do photosynthesis.
...
# this artificial threshold I have set. 
  ...
  ## thorn_Kg is a calibration parameter. 
  ## substrate cocentrations affect growth and are modified by uptake inhibition and trasnport
...
#  use this code to simulate a loss in shoots e.g in fire
  ...
  # model to make it bi-directional. 
