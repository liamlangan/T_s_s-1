...
# Author: Liam Langan 20.11.2017 re-coded orgiginal SH code to add source sink dynamics and remove predefined allocation 
# This version with carbon organ, nitrogen organ, phosphorus organ and water organ 
# This version includes separate substrate pools for each organ and allows bi-directional 
# transport of substrates betweens organs. 
###############################################################################
